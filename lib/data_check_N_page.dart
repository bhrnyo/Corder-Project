...
class DataCheckNPage extends StatefulWidget {
  const DataCheckNPage({Key? key}) : super(key: key);

  @override
  State<DataCheckNPage> createState() => _DataCheckNPageState();
}

class _DataCheckNPageState extends State<DataCheckNPage> {
